...
from .distributionLoss import LabelDistributionLoss
from .entropyMinimization import loss_entropy

CLASS_PRIOR = {"cifar-10": 0.4, "fmnist": 0.4, "alzheimer": 0.5}
...
def create_loss(args):
    ...
    def loss_fn_entropy(outputs, labels):
        ...
        return base_loss(outputs, labels) + args.co_mu * loss_entropy(
            scores[labels != 1]
        )
